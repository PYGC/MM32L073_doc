...
|              |                                         |                                                                                                    |                                                                                                                |                                                                                                                |
|              | .. attention:: 在系统复位时清除这一位。 | .. attention:: 在待机模式下 PVD 被停止。                                                           | .. attention:: 该位由硬件设置，并只能由 POR/PDR (上电/掉电复位)                                                | .. attention:: 该位由硬件设置，并只能由 POR/PDR (上电/掉电复位)                                                |
|              |                                         |                                                                                                    |                                                                                                                |                                                                                                                |  
|              |                                         |                因此，待机模式后或复位后，直到设置 PVDE 位之前，该位为 0。                          |                或设置电源控制寄存器 (PWR_CR) 的 CSBF 位清除。                                                  |                或设置电源控制寄存器 (PWR_CR) 的 CWUF 位清除。                                                  |  
+--------------+-----------------------------------------+----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+
